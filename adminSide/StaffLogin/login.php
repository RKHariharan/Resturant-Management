...
$account_id = ""; // Define the variable to avoid undefined variable error
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> HARI'S</h1><span class="sr-only"></span></a>
