    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> Hari'S</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
...
<section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> HARI'S</h1><span></span></strong></h1>
            <h1><strong style="color:white;">DINING & BEVERAGES<span></span></strong></h1>
...
<section id="about" ">
  <div class="about container">
    <div class="col-right">
        ...
        <h2>HARI's DINING & Beverages History:</h2>
 <p>
HARI's Dining and Beverages is a renowned Indian restaurant nestled in the heart of the city, celebrated for its authentic cuisine and welcoming ambiance. Offering a diverse menu filled with flavorful Indian dishes, HARI's caters to a wide range of tastes, from traditional favorites to innovative creations. With a focus on providing a memorable dining experience, the restaurant prides itself on its attentive staff and inviting atmosphere, making it a popular choice for families, couples, and groups of friends. In addition to its indoor dining area, HARI's features an inviting outdoor space where patrons can relax and socialize while enjoying a variety of non-alcoholic beverages and delectable snacks. Open seven days a week from 11:00 AM to 10:00 PM, HARI's is the perfect destination to savor authentic Indian flavors in a vibrant setting.
 </p>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2> 62, Third Floor, Anna nagar ,Opp to KFC, Madurai, 625010</h2>
        </div>
      </div>
    </div>
  </div>
...
<!-- End Contact Section -->
  ...
  <section id="footer">
    <div class="footer container">
      ...
      <p>© 2024 HARI'S Dining and Beverages </p>
